...
export default function ShareSpaceModal({ spaceId }: { spaceId: number }) {
  ...
  const loadShares = useCallback(async () => {
    const res = await fetch(`/api/spaces/${spaceId}/shares`)
  ...
  async function handleRemove(shareId: number) {
    await fetch(`/api/spaces/${spaceId}/shares/${shareId}`, { method: 'DELETE' })
